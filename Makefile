...
release:          ## Create a new tag for release.
	...
	@echo "$${TAG}" > project_template/VERSION
	@$(ENV_PREFIX)gitchangelog > HISTORY.md
	@git add project_template/VERSION HISTORY.md
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "project_template = 'project_template.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run project_template'"
